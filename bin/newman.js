...
program
    ...
    .action((collection, command) => {
        ...
        newman.run(options, function (err, summary, newmanStatus) {
            // err -> can be error while fetching options / extracting runnable items /
            //         error while uploading  / premature error in done
            // summary.run.error -> when we get a error in making a request , we just stop the entire run.
